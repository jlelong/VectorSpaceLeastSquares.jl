```@meta
EditURL = "https://github.com/jlelong/VectorSpaceLeastSquares.jl/blob/master/CHANGELOG.md"
```
...
- Fix Variance standard variance mismatch when creating a Gaussian kernel.
